...
const settings = {
  name: "Hanzzy Api's",
  description: "Hanzzy Api is a simple and lightweight REST API built with Express.js",
  apiSettings: { creator: "Hanzzy", apikey: ["key1", "key2", "123"] },
  linkWhatsapp: "https://whatsapp.com/channel/0029VbBL0NVISTkS67Qhjn0J",
  linkYoutube: "https://www.youtube.com/@hanzzymarket"
};
...
app.use((req, res, next) => {
  ...
  res.json = function (data) {
    if (data && typeof data === 'object') {
      const responseData = { status: data.status, creator: settings.apiSettings.creator || "Created Using Hanzzy", ...data };
